...
* Output is in order of closeness. The first row two rows show some matches that are less than 1¢ away from 5/4, including `^10|31`. 31-EDO is known to have a very good major third. You can also see that 53-EDO has a very good major third.
...
* `Δ cents` — how far off the generate note's pure ratio is from the desired pitch in cents
...
* Consider the row that starts with `2^4|12`.
  ...
  * The value of 1.260 shows is slightly above 1.250, which is 5/4. This is expected since the major third is sharp in 12-EDO.
