...
<img src="../../syntoniq-logo.svg" alt="Syntoniq Logo" style="height: 30em; vertical-align: middle;">
</div>
<figcaption>The Syntoniq Logo</figcaption>
</figure>
</center>

The logo was hand-coded in PostScript and converted programmatically to SVG. You can find the logo in the [logo directory](https://github.com/jberkenbilt/syntoniq/tree/main/logo) of the source repository.
...
The overall outer shape of the logo is a comma. This is because of the *syntonic comma*, which is the ratio 81/80. This is discussed in the section on the [Syntoniq Name](../syntoniq-name/).
