...
* To cover
  * Other features
    ...
    * Dynamics
    * Mark, repeat; mention about timeline, not token stream. It has to be understood that repeats are temporal repeats, not lexical repeats. If you think about it this way, the constraints are logical.
      * Disadvantages
