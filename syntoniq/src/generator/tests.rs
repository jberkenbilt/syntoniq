...
fn test_options() -> anyhow::Result<()> {
    ...
    let test_cases = [
        ...
        (
            "test22-interpolate",
            "in-flight-pitch-increase2",
            Options {
                start_mark: Some("a".to_string()),
                end_mark: Some("c".to_string()),
                skip_repeats: false,
                tempo_percent: None,
                skip_beats: Some(1),
                skip_end_beats: Some(1),
        ...
        (
            "test22-interpolate",
            "in-flight-pitch-decrease1",
            Options {
                start_mark: Some("e".to_string()),
                end_mark: Some("f".to_string()),
                skip_repeats: false,
                tempo_percent: None,
                skip_beats: Some(1),
                skip_end_beats: Some(1),
        ...
        (
            "test22-interpolate",
            "in-flight-pitch-decrease2",
            Options {
                start_mark: Some("e".to_string()),
                end_mark: Some("g".to_string()),
                skip_repeats: false,
                tempo_percent: None,
                skip_beats: Some(1),
                skip_end_beats: Some(1),
