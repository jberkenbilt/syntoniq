...
; mark 'b' @'[433,436)
i 1.1 6 1 1 391.995 0.567 ; q @506
i 1.4 6 1 2 783.991 0.567 ; g' @522
; mark 'c' @'[620,623)
; repeat start 'a' @'[638,641)
...
; repeat end 'b' @'[646,649)
i 1.1 12 1 1 261.626 0.567 ; p @682
i 1.4 12 1 2 523.251 0.567 ; c' @698
; mark 'd' @'[714,717)
; repeat start 'c' @'[794,797)
; repeat start 'a' @'[638,641)
...
; repeat end 'b' @'[646,649)
i 1.1 18 1 1 261.626 0.567 ; p @682
i 1.4 18 1 2 523.251 0.567 ; c' @698
; repeat end 'd' @'[802,805)
i 1.1 20 1 1 130.813 0.567 ; 1:p, @877
i 1.4 20 1 2 261.626 0.567 ; 1:c @889
;; END SYNTONIQ
