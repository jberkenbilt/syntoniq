...
i 1.1 0 1 1 293.665 0.567 ; 1:d @105
i "SetPartParam" 0 0.01 1 "notes" 2
i 1.2 0 1 1 369.994 0.567 ; 1:f# @119
i "SetPartParam" 0 0.01 1 "notes" 3
i 1.3 0 1 1 440 0.567 ; 1:a @133
; mark 'a' @'[218,221)
i "SetPartParam" 2 0.01 1 "notes" 1
i 1.1 2 1 1 130.813 0.567 ; 1:p, @280
i "SetPartParam" 2 0.01 2 "notes" 1
i 1.4 2 1 2 261.626 0.567 ; 1:c @292
i 1.1 3 1 1 329.628 0.567 ; 1:e @329
i "SetPartParam" 3 0.01 1 "notes" 2
i 1.2 3 1 1 391.995 0.567 ; 1:g @340
i "SetPartParam" 3 0.01 1 "notes" 3
i 1.3 3 1 1 493.883 0.567 ; 1:b @351
i "SetPartParam" 4 0.01 1 "notes" 1
i 1.1 4 1 1 195.998 0.567 ; 1:q, @403
i 1.4 4 1 2 391.995 0.567 ; 1:q @415
; mark 'b' @'[430,433)
i 1.1 6 1 1 391.995 0.567 ; q @502
i 1.4 6 1 2 783.991 0.567 ; g' @518
; mark 'c' @'[616,619)
; repeat start 'a' @'[634,637)
i 1.1 8 1 1 130.813 0.567 ; 1:p, @280
i 1.4 8 1 2 261.626 0.567 ; 1:c @292
i 1.1 9 1 1 329.628 0.567 ; 1:e @329
i "SetPartParam" 9 0.01 1 "notes" 2
i 1.2 9 1 1 391.995 0.567 ; 1:g @340
i "SetPartParam" 9 0.01 1 "notes" 3
i 1.3 9 1 1 493.883 0.567 ; 1:b @351
i "SetPartParam" 10 0.01 1 "notes" 1
i 1.1 10 1 1 195.998 0.567 ; 1:q, @403
i 1.4 10 1 2 391.995 0.567 ; 1:q @415
; repeat end 'b' @'[642,645)
i 1.1 12 1 1 261.626 0.567 ; p @678
i 1.4 12 1 2 523.251 0.567 ; c' @694
; mark 'd' @'[710,713)
; repeat start 'c' @'[790,793)
; repeat start 'a' @'[634,637)
i 1.1 14 1 1 130.813 0.567 ; 1:p, @280
i 1.4 14 1 2 261.626 0.567 ; 1:c @292
i 1.1 15 1 1 329.628 0.567 ; 1:e @329
i "SetPartParam" 15 0.01 1 "notes" 2
i 1.2 15 1 1 391.995 0.567 ; 1:g @340
i "SetPartParam" 15 0.01 1 "notes" 3
i 1.3 15 1 1 493.883 0.567 ; 1:b @351
i "SetPartParam" 16 0.01 1 "notes" 1
i 1.1 16 1 1 195.998 0.567 ; 1:q, @403
i 1.4 16 1 2 391.995 0.567 ; 1:q @415
; repeat end 'b' @'[642,645)
i 1.1 18 1 1 261.626 0.567 ; p @678
i 1.4 18 1 2 523.251 0.567 ; c' @694
; repeat end 'd' @'[798,801)
i 1.1 20 1 1 130.813 0.567 ; 1:p, @873
i 1.4 20 1 2 261.626 0.567 ; 1:c @885
;; END SYNTONIQ
