...
t 0 150 6 160 12 180 18 180 18 180
; repeat start 'verse-start' @'[484,497)
i "SetPartParam" 0 0.01 1 "notes" 1
i 1.1 0 1 1 261.626 0.567 ; 1:c @161
i 1.1 1 1 1 329.628 0.567 ; e @165
i 1.1 2 1 1 391.995 0.567 ; g @167
i 1.1 3 1 1 349.228 0.567 ; f @169
i 1.1 4 1 1 329.628 0.567 ; e @171
i 1.1 5 1 1 293.665 0.567 ; d @173
i 1.1 6 1 1 261.626 0.567 ; c @177
i 1.1 7 1 1 329.628 0.567 ; e @179
i 1.1 8 1 1 391.995 0.567 ; g @181
i 1.1 9 2 1 261.626 0.567 ; 2:c @183
; mark 'chorus-main-start' @'[212,231)
i 1.1 12 1 1 261.626 0.567 ; 1:c @255
i 1.1 13 1 1 329.628 0.567 ; e @259
i 1.1 14 1 1 391.995 0.567 ; g @261
; mark 'chorus-main-end' @'[274,291)
i 1.1 15 2 1 440 0.567 ; 2:a @315
; repeat start 'chorus-main-start' @'[350,369)
i 1.1 18 1 1 261.626 0.567 ; 1:c @255
i 1.1 19 1 1 329.628 0.567 ; e @259
i 1.1 20 1 1 391.995 0.567 ; g @261
; repeat end 'chorus-main-end' @'[374,391)
i 1.1 21 2 1 261.626 0.567 ; 2:c @416
; repeat end 'verse-end' @'[502,513)
; mark 'ending' @'[533,541)
i 1.1 24 2 1 391.995 0.567 ; 2:g @550
i 1.1 26 1 1 391.995 0.567 ; 1:g @554
i 1.1 27 1 1 349.228 0.567 ; f @558
i 1.1 28 1 1 329.628 0.567 ; e @560
i 1.1 29 1 1 293.665 0.567 ; d @562
i 1.1 30 4 1 261.626 0.567 ; 4:c @566
;; END SYNTONIQ
