...
t 0 180 6 180 6 180 12 180 12 150 18 160 24 160 24 180 30 180 30 180
i 1.1 0 1 1 261.626 0 0.567 ; 1:c @255
i 1.1 1 1 1 329.628 0 0.567 ; e @259
i 1.1 2 1 1 391.995 0 0.567 ; g @261
; mark 'chorus-main-end' @'[274,291)
i 1.1 3 2 1 440 0 0.567 ; 2:a @315
; repeat start 'chorus-main-start' @'[350,369)
i 1.1 6 1 1 261.626 0 0.567 ; 1:c @255
i 1.1 7 1 1 329.628 0 0.567 ; e @259
i 1.1 8 1 1 391.995 0 0.567 ; g @261
; repeat end 'chorus-main-end' @'[374,391)
i 1.1 9 2 1 261.626 0 0.567 ; 2:c @416
; mark 'verse-end' @'[435,446)
; repeat start 'verse-start' @'[484,497)
i 1.1 12 1 1 261.626 0 0.567 ; 1:c @161
i 1.1 13 1 1 329.628 0 0.567 ; e @165
i 1.1 14 1 1 391.995 0 0.567 ; g @167
i 1.1 15 1 1 349.228 0 0.567 ; f @169
i 1.1 16 1 1 329.628 0 0.567 ; e @171
i 1.1 17 1 1 293.665 0 0.567 ; d @173
i 1.1 18 1 1 261.626 0 0.567 ; c @177
i 1.1 19 1 1 329.628 0 0.567 ; e @179
i 1.1 20 1 1 391.995 0 0.567 ; g @181
i 1.1 21 2 1 261.626 0 0.567 ; 2:c @183
; mark 'chorus-main-start' @'[212,231)
i 1.1 24 1 1 261.626 0 0.567 ; 1:c @255
i 1.1 25 1 1 329.628 0 0.567 ; e @259
i 1.1 26 1 1 391.995 0 0.567 ; g @261
; mark 'chorus-main-end' @'[274,291)
i 1.1 27 2 1 440 0 0.567 ; 2:a @315
; repeat start 'chorus-main-start' @'[350,369)
i 1.1 30 1 1 261.626 0 0.567 ; 1:c @255
i 1.1 31 1 1 329.628 0 0.567 ; e @259
i 1.1 32 1 1 391.995 0 0.567 ; g @261
; repeat end 'chorus-main-end' @'[374,391)
i 1.1 33 2 1 261.626 0 0.567 ; 2:c @416
; repeat end 'verse-end' @'[502,513)
; mark 'ending' @'[533,541)
i 1.1 36 2 1 391.995 0 0.567 ; 2:g @550
i 1.1 38 1 1 391.995 0 0.567 ; 1:g @554
i 1.1 39 1 1 349.228 0 0.567 ; f @558
i 1.1 40 1 1 329.628 0 0.567 ; e @560
i 1.1 41 1 1 293.665 0 0.567 ; d @562
i 1.1 42 4 1 261.626 0 0.567 ; 4:c @566
;; END SYNTONIQ
