...
t 0 90 2 90 2 60 4 60 4 60 5 60 5 90 8 90 8 180 10 180 10 90 11 90 11 60
i 1.1 0 0.5 1 349.228 0 0.567 ; 1/2:f @693
i 1.1 0.5 0.5 1 349.228 0 0.567 ; f @699
i 1.1 1 0.5 1 349.228 0 0.567 ; f @701
i 1.1 1.5 0.5 1 349.228 0 0.567 ; f @703
i 1.1 2 0.5 1 391.995 0 0.567 ; 1/2:g @857
i 1.1 2.5 0.5 1 391.995 0 0.567 ; g @863
i 1.1 3 0.5 1 391.995 0 0.567 ; g @865
i 1.1 3.5 0.5 1 391.995 0 0.567 ; g @867
; repeat start 'a1' @'[883,887)
i 1.1 4 0.5 1 329.628 0 0.567 ; 1/2:e @580
i 1.1 4.5 0.5 1 329.628 0 0.567 ; e @586
i 1.1 5 0.5 1 349.228 0 0.567 ; f @588
i 1.1 5.5 0.5 1 349.228 0 0.567 ; f @590
; repeat end 'a2' @'[892,896)
; mark 'c' @'[910,913)
i 1.1 6 0.5 1 440 0 0.567 ; 1/2:a @940
i 1.1 6.5 0.5 1 440 0 0.567 ; a @946
i 1.1 7 0.5 1 440 0 0.567 ; a @948
i 1.1 7.5 0.5 1 440 0 0.567 ; a @950
; mark 'd' @'[1008,1011)
; repeat start 'c' @'[1068,1071)
i 1.1 8 0.5 1 440 0 0.567 ; 1/2:a @940
i 1.1 8.5 0.5 1 440 0 0.567 ; a @946
i 1.1 9 0.5 1 440 0 0.567 ; a @948
i 1.1 9.5 0.5 1 440 0 0.567 ; a @950
; repeat end 'd' @'[1076,1079)
i 1.1 11 0.5 1 493.883 0 0.567 ; 1/2:b @1270
i 1.1 11.5 0.5 1 493.883 0 0.567 ; b @1276
i 1.1 12 0.5 1 493.883 0 0.567 ; b @1278
i 1.1 12.5 0.5 1 493.883 0 0.567 ; b @1280
;; END SYNTONIQ
