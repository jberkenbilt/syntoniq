...
pub struct Options {
    ...
    /// Skip specified number of whole beats from the beginning or specified start
    /// mark
    #[arg(long)]
    pub skip_beats: Option<u32>,
    /// Skip specified number of whole beats from the end or specified end mark
    #[arg(long)]
    pub skip_end_beats: Option<u32>,
